...
def from_InChI(
    InChI: str, sanitize:bool = False, with_hydrogen: bool = False, kekulize: bool = False, dtype=torch.long
) -> Data:
    ...
    return Data(x=x, edge_index=edge_index, edge_attr=edge_attr, InChI=InChI)
...
def from_smiles(
    smile: str, sanitize:bool = False, with_hydrogen: bool = False, kekulize: bool = False, dtype=torch.long
) -> Data:
    ...
    return Data(x=x, edge_index=edge_index, edge_attr=edge_attr, smile=smile)